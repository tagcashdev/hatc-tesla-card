...
| ---- | ---- | ------ | ------- | ----------- | ------- |
| type | string | **Obligatoire** | - | `custom:hatc-tesla-card` | - |
| entity | string | **Obligatoire** | - | `sensor‧processor_temperature` | - |
| [card](https://github.com/tagcashdev/hatc-tesla-card/#card-options) | object | Optionnel | null | Permet de changer la hauteur de la carte, [voir exemple](https://github.com/tagcashdev/hatc-tesla-card/#default) | px |
| [title](https://github.com/tagcashdev/hatc-tesla-card/#title-options) | string/object | Optionnel | entity‧attribute.friendly_name | Permet de changer le titre de la carte, [voir exemple](https://github.com/tagcashdev/hatc-tesla-card/#titre-simple) | false, '', hide, string, object [voir configuration](https://github.com/tagcashdev/hatc-tesla-card/#title-options) |
| [gauge](https://github.com/tagcashdev/hatc-tesla-card/#gauge-options) | object | Optionnel | - | Configuration de la Jauge | - |
...
| [severity](https://github.com/tagcashdev/hatc-tesla-card/#severity-options) | object | Optionnel | - | Configuration severity | - |
...
title: Titre de la carte
```
![Titre Simple](https://github.com/tagcashdev/hatc-tesla-card/blob/main/img/titre-simple.png)
...
title:
  ...
  icon: severity
```
![Titre options](https://github.com/tagcashdev/hatc-tesla-card/blob/main/img/titre-options.png)
...
title: false
```
![Titre options](https://github.com/tagcashdev/hatc-tesla-card/blob/main/img/cacher-titre.png)
...
gauge:
  ...
  severity:
    ...
    - color: purple
      ...
      to: 50
```
![Gauge Options](https://github.com/tagcashdev/hatc-tesla-card/blob/main/img/gauge-options.png)
